...
import {transformDiffPlugin} from '../packages/transform/transformDiff'
...
describe("transform test", () => {
    test("transform at transformDiff()", () => {
        ...
        const oldGenerate = transform(oldAst, {diffAst: newAst, nodeTransforms: [['all', transformDiffPlugin()]]});
        const newGenerate = transform(newAst, {diffAst: oldAst, nodeTransforms: [['all', transformDiffPlugin()]]});
        ...
        const oldGenerate2 = transform(oldAst2, {diffAst: newAst2, nodeTransforms: [['all', transformDiffPlugin()]]});
        const newGenerate2 = transform(newAst2, {diffAst: oldAst2, nodeTransforms: [['all', transformDiffPlugin()]]});
        ...
        const oldGenerate3 = transform(oldAst3, {diffAst: newAst3, nodeTransforms: [['all', transformDiffPlugin()]]});
        const newGenerate3 = transform(newAst3, {diffAst: oldAst3, nodeTransforms: [['all', transformDiffPlugin()]]});
        ...
        const oldGenerate4 = transform(oldAst4, {diffAst: newAst4, nodeTransforms: [['all', transformDiffPlugin()]]});
        const newGenerate4 = transform(newAst4, {diffAst: oldAst4, nodeTransforms: [['all', transformDiffPlugin()]]});
        ...
        // </table>
        // </div>`);
        // const oldGenerate5 = transform(oldAst5, {diffAst: newAst5, nodeTransforms: [['all', transformDiffPlugin()]]});
        // const newGenerate5 = transform(newAst5, {diffAst: oldAst5, nodeTransforms: [['all', transformDiffPlugin()]]});
        ...
        const oldAst6 = htmlParser.parser("**菜单位置：**\n\n**背景：**\n\n**现有功能：**\n\n**期望功能：**\n\n**备注：**\n\n");
        const newAst6 = htmlParser.parser("**菜单位置：**\n\n**背景：**\n\n**现有功能：**\n\n**期望功能：**\n\n**备注：**\n1\n\n");
        const oldGenerate6 = transform(oldAst6, {diffAst: newAst6, nodeTransforms: [['all', transformDiffPlugin()]]});
        const newGenerate6 = transform(newAst6, {diffAst: oldAst6, nodeTransforms: [['all', transformDiffPlugin()]]});

        expect(oldGenerate6).toBe("");
        expect(newGenerate6).toBe("");
    })
});